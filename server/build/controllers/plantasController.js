...
class PlantasController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const plantas = yield database_1.default.query('SELECT plant.created_at, plant.id_planta AS id_planta, plant.nome_planta AS nome_planta, plant.id_caracteristica_1_1 AS id_caracteristica_1_1,'
    ...
    listAlelos1(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const plantas = yield database_1.default.query('SELECT * FROM alelos_1_1');
            res.json(plantas);
            res.json('listando as alelos 1');
        });
    }
    listAleloscaract_1(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const plantas = yield database_1.default.query('SELECT caract.*, al1.id_ale1 AS alelo_1_1_id, al1.nome_ale1 AS alelo_1_1_nome, '
    ...
    listCaract2(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const plantas = yield database_1.default.query('SELECT caract.*, al1.id_ale1 AS alelo_1_1, al1.nome_ale1 AS alelo_1_1, al1.valor_ale1 AS alelo_1_1,'
    ...
    listCaract3(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const plantas = yield database_1.default.query('SELECT caracteristica_1_1.id_caract1, caracteristica_1_1.nome_caract,caracteristica_1_1.id_alelos_1_1,caracteristica_1_1.id_alelos_1_2,  '
    ...
    list1(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const plantas = yield database_1.default.query('SELECT plantas.nome, caracteristica_1_2.nome, alelos_1_1.nome, alelos_1_1.valor,'
    ...
    getOnePlanta(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id_planta } = req.params;
            const plantas = yield database_1.default.query('SELECT * FROM  plantas WHERE id_planta = ?', [id_planta]);
            if (plantas.length > 0) {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('INSERT INTO alelos_1_1 set ?', [req.body]);
            res.json({ message: 'A planta foi criado novamente até que enfim mano!' });
        });
    }
    update(req, res) {
        const { id } = req.params;
        database_1.default.query('UPDATE plantas set ? WHERE id = ?', [req.body, id]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('DELETE FROM plantas WHERE id_planta = ?', [id_planta]);
            res.json({ message: 'deletado a planta :( !!' });
        });
    }
    createAlelo1(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(req.body);
            yield database_1.default.query('INSERT INTO alelos_1_1 set ?', [req.body]);
    ...
    createAlelo2(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(req.body);
            yield database_1.default.query('INSERT INTO alelos_1_2 set ?', [req.body]);
    ...
    createPlanta(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(req.body);
            yield database_1.default.query('INSERT INTO plantas set ?', [req.body]);
            res.json({ message: 'A Planta  foi criado!' });
        });
    }
    createCaract1(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(req.body);
            yield database_1.default.query('INSERT INTO caracteristica_1_1 set ?', [req.body]);
            res.json({ message: 'A Caracteristica 1  foi criado!' });
        });
    }
    createCaract2(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(req.body);
            yield database_1.default.query('INSERT INTO caracteristica_1_1 set ?', [req.body]);
...
exports.default = plantasController;
